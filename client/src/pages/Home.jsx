        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
            ...
            <div className="space-y-4">
              {/* Borrowed Books Card */}
              <div
                onClick={() => navigate('/borrowed-books?tab=borrowed')}
              ...
              {/* Returned Books Card */}
              <div
                onClick={() => navigate('/borrowed-books?tab=returned')}
                className="bg-white rounded-lg shadow-sm p-6 flex items-center gap-4 cursor-pointer hover:shadow-md transition-shadow"
              >
                <div className="w-16 h-16 bg-gray-200 rounded-lg flex items-center justify-center flex-shrink-0">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white rounded-lg shadow-sm p-6 text-center">
                <h1 className="text-4xl sm:text-5xl font-bold">Aurevia Library Management System</h1>
