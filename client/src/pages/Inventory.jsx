                    ...
                    <div className="flex flex-col md:flex-row md:flex-wrap gap-4 md:gap-8 items-start md:items-center justify-between mb-6">
                        ...
                        <div className="w-full md:w-auto grow flex flex-col md:flex-row flex-wrap gap-2 md:gap-4 items-stretch md:items-center md:space-x-3">
                            ...
                            <button
                                ...
                                className={`inline-flex text-black items-center justify-center px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500 w-full md:w-auto ${showArchived
                            ...
                            {!showArchived && (
                                <button
                                    ...
                                    className="inline-flex items-center justify-center px-4 py-2 bg-blue-600 text-black rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 w-full md:w-auto"
                                >
